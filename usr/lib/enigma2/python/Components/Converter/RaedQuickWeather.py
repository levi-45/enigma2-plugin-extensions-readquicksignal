...
weather_city = config.plugins.RQweather.city.value
degreetype = config.plugins.RQweather.degreetype.value
windtype = config.plugins.RQweather.windtype.value
weather_location =  config.plugins.RQweather.weather_location.value

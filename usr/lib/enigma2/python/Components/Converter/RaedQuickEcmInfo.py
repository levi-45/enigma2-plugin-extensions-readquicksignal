                ...
                if self.type == self.emuname:
                        ...
                        if os.path.exists(resolveFilename(SCOPE_PLUGINS, "Extensions/AlternativeSoftCamManager/plugin.py")): 
                                if config.plugins.AltSoftcam.actcam.value != "none": 
                                        ...
                                        return None
                        # VIX
                        elif fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/ViX/SoftcamManager.pyo"):
                                if fileExists('/tmp/cam.check.log'):
                        ...
                        #HDMU
                                ...
                                try:
                                        ...
                                        camdlist = None
                        # SPA
                        elif fileExists("/etc/.ActiveCamd"):
                                try:
                        ...
                        # GP4
                                ...
                                return None
                        # GP4 OE2.5
                        elif fileExists("/usr/lib/enigma2/python/Plugins/GP4/geminicamswitch/gscamScreen.pyo"):
                        ...
                        # Dream Elite
                                ...
                                try:
                                        ...
                                        return None
                        # ATV for 6.3
                        elif fileExists("/etc/init.d/softcam") and not fileExists(BRANDPLI):
                                for line in open("/etc/init.d/softcam"):
                                        if "# Short-Description:" in line:
                                                return line.split(':')[-1].lstrip().strip('\n')
                        # Pli/OV
                        elif fileExists(BRANDPLI) and fileExists("/etc/init.d/softcam") or fileExists("/etc/init.d/cardserver"):
                                try:
                                	for line in open("/etc/init.d/softcam"):
                                		if "echo" in line:
                                			nameemu.append(line)
